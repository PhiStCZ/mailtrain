...
async function createTx(tx, context, listId, entity) {
    ...
    await activityLog.logEntityActivityWithContext(context, LogTypeId.LIST, ListActivityType.CREATE_FIELD, listId, {fieldId: id});
...
async function updateWithConsistencyCheck(context, listId, entity) {
    await knex.transaction(async tx => {
        ...
        await activityLog.logEntityActivityWithContext(context, LogTypeId.LIST, ListActivityType.UPDATE_FIELD, listId, {fieldId: entity.id});
    });
}
...
async function removeTx(tx, context, listId, id) {
    ...
    await activityLog.logEntityActivityWithContext(context, LogTypeId.LIST, ListActivityType.REMOVE_FIELD, listId, {fieldId: id});
}
