...
async function create(context, campaignId, entity) {
    return await knex.transaction(async tx => {
        ...
        await activityLog.logEntityActivityWithContext(context, 'campaign', CampaignActivityType.CREATE_TRIGGER, campaignId, {triggerId: id});
...
async function updateWithConsistencyCheck(context, campaignId, entity) {
    await knex.transaction(async tx => {
        ...
        await activityLog.logEntityActivityWithContext(context, 'campaign', CampaignActivityType.UPDATE_TRIGGER, campaignId, {triggerId: entity.id});
    });
}
...
async function removeTx(tx, context, campaignId, id) {
    ...
    await activityLog.logEntityActivityWithContext(context, 'campaign', CampaignActivityType.REMOVE_TRIGGER, campaignId, {triggerId: id});
}
